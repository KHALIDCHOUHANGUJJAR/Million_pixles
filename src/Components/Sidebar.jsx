...
function Sidebar() {
  return (
    <div className="h-screen xl:w-[20%]  fixed z-10  2xl:w-[20%]  bg-[#171717] rounded-r-4xl  text-text-200  flex flex-col items-center">
      <div className="flex flex-col p-3 justify-between w-[18vw] 2xl:w-[16vw] h-full">
        <div>
          ...
          <nav
            className=" bg-blacke-400 text-[#777777] 
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center xl:py-1.5 2xl:py-4.5 px-6 hover:bg-gray-700 ${
                  isActive ? "bg-orange-500 text-[#FFFFFF] rounded-2xl" : ""
                } text-lg font-bold`
              }
            >
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center xl:py-1.5 2xl:py-4.5 px-6   w-full hover:bg-gray-700 ${
                  isActive ? "bg-orange-500 rounded-2xl text-[#FFFFFF]" : ""
                } text-lg font-bold`
              }
            >
          ...
          <div
            className="mt-2 2xl:mt-6  p-1 2xl:p-2
             rounded-2xl bg-blacke-400 border-2
          ...
          >
            <NavLink
              to="/notifications"
              className={({ isActive }) =>
                `flex items-center gap-3 2xl:py-3 py-2 px-4 rounded-xl hover:bg-gray-700 ${
                  isActive ? "bg-orange-500 text-white" : "bg-blacke-400"
                }`
              }
            >
        ...
        <div className=" 2xl:mb-24 mb-8">
          <button
           ...
           border-2 border-[#413e3e]  p-4 xl:py-3 2xl:py-4 bg-blacke-400
            text-[#777777] font-black py-3 rounded-3xl 2xl:rounded-4xl hover:bg-gray-700 hover:text-text-200"
          >

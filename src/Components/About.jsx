  ...
  return (
    <div className="flex items-center flex-col">
      ...
      >
        ...
        <div className="p-4 flex flex-col gap-9 2xl:gap-8 w-full lg:w-[30%] 2xl:w-[32%]">
          <img
            src="/Assets/Images/Group 1000004117 1.png"
            alt="Pixel Art"
          ...
          <div className="p-2 2xl:p-6 border-2 border-[#343434] rounded-2xl shadow-md">
            <div className="flex items-center justify-between mb-4 2xl:mb-6">
              <div>
                ...
                <p className="text-sm 2xl:text-xl text-gray-400">
                  Last Updated: Recent
                </p>
              </div>
            ...
            <div className="flex flex-col gap-4 2xl:gap-10 bg-[#272727] p-4 2xl:p-10 rounded-xl">
              ...
              <div className="flex items-center">
                ...
                <div className="w-[50%] lg:w-[15vw] 2xl:w-[15vw] p-2 2xl:p-3 rounded-2xl bg-[#704839] absolute left-[45%] lg:left-[49%] z-0"></div>
              </div>
            ...
            {["Manage Pixels", "Order Pixels", "My order History "].map(
              (label, index) => (
                <div
                  ...
                  rounded-3xl text-center xl:px-2  2xl:px-10 xl:h-10.5 
                ...
                >
                  <PlusCircleOutlined className="text-2xl cursor-pointer" />
                  {label}
                </div>
              )
            )}

  ...
  return (
    <div>
      <header className="flex flex-col w-full 2xl:w-[100%] p-5 h-[20vh] bg-[#00000] gap-2">
        <div className="flex justify-between w-full mb-1 2xl:mb-8">
          <div>
          ...
          <div
            className="2xl:p-6 flex border-2 text-[#8a8686] font-semibold rounded-3xl 
           text-center p-1 text-md 2xl:text-xl h-10 text-sm items-center border-gray-700 bg-[#171717] px-3"
          >
            <LuCrown className="2xl:text-2xl" />
            Pro Member
          </div>
          <div className="flex gap-10">
            <div className="flex gap-1.5 ml-1">
              <div className="bg-[#A86D5B] xl:h-[2.5vw] 2xl:h-[3vw] text-center flex items-center justify-center w-9 2xl:w-12 rounded-full text-black border-[#696464] relative">
                CM
              </div>
              ...
              <div
                className="2xl:p-7 flex border-2 text-[#8a8686] font-semibold
              2xl:rounded-4xl
            ...
            <div className="ml-11 flex border-2 justify-between gap-3 text-[#8a8686] font-semibold rounded-3xl text-center xl:p-4 2xl:p-7 h-10 items-center bg-[#171717] border-gray-700 px-3">
              ...
              <IoIosContact className="xl:text-3xl 2xl:text-5xl rounded-full text-white bg-[#2EBC96]" />
            </div>
          </div>
        </div>
              ...
              <div key={index}>
                {label === "Edit Pixels" ? (
                  <div
                    ...
                    2xl:rounded-4xl rounded-3xl text-center xl:p-2 px-8 2xl:p-7 2xl:px-10 h-10 
